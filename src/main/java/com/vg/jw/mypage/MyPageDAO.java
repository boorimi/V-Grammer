...
//		long twitterId = (long) twitterLoginSession.getAttribute("twitterId");
		...
		String sql = "SELECT hg.*, hi.i_icon, hm.m_name, hm.m_personalcolor from haco_goods hg, haco_member hm, haco_image hi WHERE hi.i_m_pk = hg.g_m_pk and hi.i_m_pk = hm.m_pk and g_u_t_id = ? and g_category ='bromide'";
...
//		long twitterId = (long) twitterLoginSession.getAttribute("twitterId");
		...
		// icon, 멤버이름, 멤버pk, 유저트위터id, 굿즈수량 등 실제로 필요한 정보들 - DTO에 모아서 정리할 값들임
		String sql = "SELECT hg.*, hi.i_icon, hm.m_name, hm.m_personalcolor from haco_goods hg, haco_member hm, haco_image hi WHERE hi.i_m_pk = hg.g_m_pk and hi.i_m_pk = hm.m_pk and g_u_t_id = ? and g_category ='76mmCanBadge'";
...
//		long twitterId = (long) twitterLoginSession.getAttribute("twitterId");
		...
		// icon, 멤버이름, 멤버pk, 유저트위터id, 굿즈수량 등 실제로 필요한 정보들 - DTO에 모아서 정리할 값들임
		String sql = "SELECT hg.*, hi.i_icon, hm.m_name, hm.m_personalcolor from haco_goods hg, haco_member hm, haco_image hi WHERE hi.i_m_pk = hg.g_m_pk and hi.i_m_pk = hm.m_pk and g_u_t_id = ? and g_category ='akuki'";
