...
public ImageDTO(String i_m_pk, String i_icon, String i_pic, String i_3side, String i_background) {
	super();
	this.i_m_pk = i_m_pk;
	this.i_icon = i_icon;
	this.i_pic = i_pic;
...
public String toString() {
	return "ImageDTO [i_m_pk=" + i_m_pk + ", i_icon=" + i_icon + ", i_pic=" + i_pic + ", i_3side=" + i_3side
