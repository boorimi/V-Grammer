	...
	<div class="trade-container">
		<div class="trade-title">
			...
			<div class="trade-menu" style="display: flex;">
				...
				<div class="trade-menu-name">
					<button class="trade-openSearch cute-button-gray">名前で検索 ▼</button>
				</div>
			</div>
			<div id="insert-button">
				<button class="cute-button-blue"
					onclick="location.href='InsertTrade'">作成</button>
			</div>
		</div>
		<form action="Trade">
			<c:choose>
		...
		<div class="archive-paging-container">
			...
			<div class="archive-paging-unit-prev">
				<c:if test="${page != 0}">
					<a href="TradePage?p=${page - pageUnit + 1}${category3 }${name2}">以前
						${pageUnit }ページ</a>
				</c:if>
			</div>
			...
			<div class="archive-paging-unit-next">
				<c:if
					...
					<a href="TradePage?p=${page + pageUnit + 1 }${category3 }${name2}">次
						${pageUnit }ページ</a>
				</c:if>
			</div>
							...
							<div class="trade-comments" style="display: none; margin: 15px">
								...
								<div>
									...
									<c:if test="${sessionScope.twitterId == tc.sTwitterId}">
										<div>
											<a onclick="tradeCommentsDelete('${tc.pk}')"> <img
