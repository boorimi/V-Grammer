  ...
  <body>
    ...
    <div class="schedule-container">
      <div class="s-week-list">
        ...
        <!-- 수 -->
        <input id="s-wed" type="radio" name="tab_item" />
        <label class="tab_item" for="s-wed">${thisWeek[2] } 水</label>
        <!-- 목 -->
        <input id="s-thu" type="radio" name="tab_item" />
        <label class="tab_item" for="s-thu">${thisWeek[3] } 木</label>
        <!-- 금 -->
